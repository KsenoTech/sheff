        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    description = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    time_order = table.Column<DateTime>(type: "datetime", nullable: false),
                    general_budget = table.Column<int>(type: "int", nullable: false),
                    feedback_text = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    IsItFinished = table.Column<bool>(type: "bit", nullable: false),
                    canIdoIt = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    e_mail = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: false),
                    login = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    password = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    address = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    kolvoZakazov = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id_Smeta = table.Column<int>(type: "int", nullable: false),
                    Id_Proveded_Service = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SmetaOrder", x => new { x.Id_Smeta, x.Id_Proveded_Service });
                    table.ForeignKey(
                        name: "FK_SmetaOrder_Provided_Service",
                        column: x => x.Id_Proveded_Service,
                        principalTable: "Provided_Service",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_SmetaOrder_Smeta",
                        column: x => x.Id_Smeta,
                        principalTable: "Smetas",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_VidRabot_Provided_Service",
